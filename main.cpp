...
// }
// void printBack(){
//   char theChar=(char) debugPort.getc();
//   debugPort.putc(theChar);
//   if(theChar=='a'){
//     queue->call(&stats);
//   }
// }
...
//     printf("helloworld\n");
//     serialPort.printf("hello serial\n");
//     debugPort.printf("hello debug\n");
//     debugPort.attach(callback(printBack));
//
//     ticker.attach(&cycle,1);
//     int count = 0;
//     queue->dispatch_forever();
//     // while (true) {
